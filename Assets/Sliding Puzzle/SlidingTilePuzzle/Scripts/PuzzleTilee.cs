...
public class PuzzleTilee : MonoBehaviour 
{
	...
	public void ExecuteAdditionalMove()
	{
		...
		LaunchPositionCoroutine(this.transform.parent.GetComponent<PuzzleDisplayy>().GetTargetLocation(this.GetComponent<PuzzleTilee>()));
	}
